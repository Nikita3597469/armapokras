...
export default function Header() {
  ...
  return (
    ...
    >
      <div className="container-custom flex items-center justify-between px-4 py-3 md:px-6 md:py-3">
        {/* Logo — в 1.5 раза больше */}
        ...
        <button
          ...
          className="relative z-50 flex h-10 w-10 items-center justify-center rounded-lg text-primary transition-colors hover:bg-gray-100 lg:hidden"
      ...
      <nav
        className={`fixed right-0 top-0 z-40 flex h-full w-72 flex-col bg-white pt-16 shadow-2xl transition-transform duration-300 lg:hidden ${
