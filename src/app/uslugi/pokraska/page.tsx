...
const paintingTypes = [
  {
    ...
    description:
      "Полная покраска кузова автомобиля — идеальное решение при значительных повреждениях ЛКП, смене цвета или восстановлении после ДТП. Каждый элемент тщательно подготавливается: снимаются навесные детали, проводится шлифовка, грунтование и многослойное нанесение краски с финишным лакированием.",
    price: "от 40 000 ₽",
    image:
      "https://images.unsplash.com/photo-1621993202323-eb4e81f5de68?w=600&h=400&fit=crop",
  },
  {
    title: "Локальная покраска",
    description:
      "Локальная покраска отдельных элементов — крыльев, дверей, бамперов, капота. Применяется при повреждении одного или нескольких элементов кузова. Подбор цвета компьютерным методом обеспечивает точное совпадение с заводским оттенком.",
    price: "от 3 500 ₽",
    image:
      "https://images.unsplash.com/photo-1603553329474-99f95f35394f?w=600&h=400&fit=crop",
  },
  {
    title: "Покраска переходом",
    description:
      "Технология покраски переходом позволяет выполнить ремонт без видимых границ между новым и старым покрытием. Незаменима при локальном ремонте, когда важно сохранить целостность внешнего вида автомобиля. Особенно актуальна для металликов и перламутров.",
    price: "от 2 500 ₽",
    image:
      "https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?w=600&h=400&fit=crop",
  },
  {
    title: "Матовая покраска",
    description:
      "Матовая покраска придаёт автомобилю уникальный и стильный вид. Используем специальные матовые лаки и краски, которые создают ровное покрытие без бликов. Доступны различные варианты — от полностью матового до сатинового финиша.",
    price: "от 50 000 ₽",
    image:
